...
public class EnemyShip : Enemy
{
    ...
    [SerializeField]    ///*** sonido de la nave
    ...
    public override void PositionEnemy()
    {
        ...
        SoundManager. instance.Play(appearSoundName); ///*** sonido de aparcer
    }
    ...
    private void Update()
    {
        ...
        CheckShootTarget();
        if (Vector3.Distance(transform.position, endPoint.position) <= distanceToShoot)
        {
            PositionEnemy();
        }
    }
    ...
    private void Shoot()
    {
        SoundManager. instance.Play(shootSoundName); ///**** Sondio de Disparo
